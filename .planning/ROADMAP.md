...
- [x] 12-06-PLAN.md — Outbox retry (1s/5s) → dedicated DLX queue + audit row, ack-after-record (W4)
...
### Phase 999.1: On-demand per-item translation (ru/de/es → no/en) (CLOSED 2026-07-22 — shipped as Phase 11 Wave 4)
