...
1. **Does `npm run dev` (web browser mode) connect to Ollama at all, or is Tauri strictly required?**
...
2. **What does World Monitor's "AI brief" output look like for non-country-specific content?**
...
3. **Is the R2 threshold stable across date ranges, or does it drift?**
